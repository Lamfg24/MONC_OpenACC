...
contains
    ...
    do while (c_has_next(iterator))
      ...
      select type(generic)
        type is (field_ordering_type)
          !****** MODIF *****
          !print*,"generic%last_timestep_access = ",generic%last_timestep_access
  ...
  subroutine provide_monc_data_to_writer_federator(io_configuration, source, data_id, data_dump)
    ...
    if (is_field_present(io_configuration, source, data_id, "timestep") .and. &
      ...
      !print*,"provide_monc_data_to_writer_federator00000"
      ...
      !print*,"provide_monc_data_to_writer_federator11111"
      do i=1, num_fields
        ...
        if (is_field_present(io_configuration, source, data_id, field_name) .and. &
          ...
          print*,"provide_monc_data_to_writer_federator field_name = ",field_name
          print*,"provide_monc_data_to_writer_federator size(monc_value%values) = ",size(monc_value%values)
  ...
  subroutine provide_field_to_writer_federator_src(io_configuration, field_name, field_namespace, &
    ...
    print*,"provide_field_to_writer_federator_src000"
    !print*,"provide_field_to_writer_federator_src field_namespace = ",field_namespace
    print*,"time_basis = ",time_basis
    print*,"nint(time) = ",nint(time)
    print*,"field_ordering%last_time_access = ",field_ordering%last_time_access
    print*,"timestep = ",timestep
    print*,"field_ordering%last_timestep_access = ",field_ordering%last_timestep_access
    ...
    if (modulo_result .eq. 0) then
      ready_to_provide = .true.
    else
      ready_to_provide = .false.
    end if
    ...
    if (ready_to_provide .or. this_is_termination) then
      ...
      print*,"provide_field_to_writer_federator_src1111"
    ...
    !print*,"provide_field_to_writer_federator_src2222 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
