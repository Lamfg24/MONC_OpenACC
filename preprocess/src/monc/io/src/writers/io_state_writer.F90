...
module io_server_state_writer_mod
  ...
  interface
     ...
     function nc_def_dim(ncid, name, nlen, idp) bind(C) ! The function nc_def_dim() adds a new dimension to an open netCDF dataset in define mode
...
contains
  ...
  subroutine set_serialise_write_field_manager_state(serialise_writer_field_manager_state_arg, &
    ...
    print*,"set_serialise_write_field_manager_state000000"
    ...
    print*,"is_write_field_manager_up_to_date_arg(5) = ",is_write_field_manager_up_to_date_arg(5)
    print*,"is_write_field_manager_up_to_date_arg(10) = ",is_write_field_manager_up_to_date_arg(10)
    print*,"is_write_field_manager_up_to_date_arg(20) = ",is_write_field_manager_up_to_date_arg(20)
    print*,"is_write_field_manager_up_to_date_arg(21) = ",is_write_field_manager_up_to_date_arg(21)
    print*,"is_write_field_manager_up_to_date(5) = ",is_write_field_manager_up_to_date(5)
    print*,"is_write_field_manager_up_to_date(10) = ",is_write_field_manager_up_to_date(10)
    print*,"is_write_field_manager_up_to_date(20) = ",is_write_field_manager_up_to_date(20)
    print*,"is_write_field_manager_up_to_date(21) = ",is_write_field_manager_up_to_date(21)
  ...
  subroutine is_io_server_state_writer_ready(timestep, ready)
    integer, intent(in) :: timestep
    logical, intent(out) :: ready
    print*,"is_io_server_state_writer_ready timestep = ",timestep
    ready = is_write_field_manager_up_to_date(timestep)
    print*,"is_io_server_state_writer_ready ready = ",ready
  end subroutine is_io_server_state_writer_ready
