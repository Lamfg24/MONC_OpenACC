...
module petsc_solver_mod
  ...
  public init_callback_petsc_solver, timestep_callback_petsc_solver, finalisation_callback_petsc_solver
...
!   end function petsc_solver_get_descriptor
 ...
 subroutine finalisation_callback_petsc_solver(current_state)
    type(model_state_type), target, intent(inout) :: current_state

    PetscErrorCode :: ierr

    call PetscFinalize(ierr)
  end subroutine finalisation_callback_petsc_solver
  ...
  subroutine init_callback_petsc_solver(current_state)
    type(model_state_type), target, intent(inout) :: current_state
  ...
  end subroutine init_callback_petsc_solver
  ...
  !! @param current_state The current model state_mod
  subroutine timestep_callback_petsc_solver(current_state)
    type(model_state_type), target, intent(inout) :: current_state
  ...
  end subroutine timestep_callback_petsc_solver
