...
contains
  ...
  subroutine advect_q_field(current_state, current_x_index, current_y_index)
    ...
    current_state%qv_advection = current_state%sqv%data(:, current_y_index, current_x_index)
    current_state%ql_advection = current_state%sql%data(:, current_y_index, current_x_index)
    current_state%qr_advection = current_state%sqr%data(:, current_y_index, current_x_index)
    current_state%qi_advection = current_state%sqi%data(:, current_y_index, current_x_index)
    current_state%qs_advection = current_state%sqs%data(:, current_y_index, current_x_index)
    current_state%qg_advection = current_state%sqg%data(:, current_y_index, current_x_index)
    current_state%qAitkenSolMass_advection = current_state%sqAitkenSolMass%data(:, current_y_index, current_x_index)
    current_state%qAccumSolMass_advection = current_state%sqAccumSolMass%data(:, current_y_index, current_x_index)
    current_state%qAccumInsolMass_advection = current_state%sqAccumInsolMass%data(:, current_y_index, current_x_index)
    current_state%qCoarseSolMass_advection = current_state%sqCoarseSolMass%data(:, current_y_index, current_x_index)
    current_state%qCoarseDustMass_advection = current_state%sqCoarseDustMass%data(:, current_y_index, current_x_index)

    current_state%nl_advection = current_state%snl%data(:, current_y_index, current_x_index)
    current_state%nr_advection = current_state%snr%data(:, current_y_index, current_x_index)
    current_state%ni_advection = current_state%sni%data(:, current_y_index, current_x_index)
    current_state%ns_advection = current_state%sns%data(:, current_y_index, current_x_index)
    current_state%ng_advection = current_state%sng%data(:, current_y_index, current_x_index)
    current_state%nAitkenSolNumber_advection = current_state%snAitkenSolNumber%data(:, current_y_index, current_x_index)
    current_state%nAccumSolNumber_advection = current_state%snAccumSolNumber%data(:, current_y_index, current_x_index)
    current_state%nAccumInsolNumber_advection = current_state%snAccumInsolNumber%data(:, current_y_index, current_x_index)
    current_state%nCoarseSolNumber_advection = current_state%snCoarseSolNumber%data(:, current_y_index, current_x_index)
    current_state%nCoarseDustnumber_advection = current_state%snCoarseDustnumber%data(:, current_y_index, current_x_index)
    !end do
  ...
  subroutine advect_th_field(current_state, current_x_index, current_y_index)
    ...
    if (current_state%th%active) then
      ...
      current_state%th_advection=current_state%sth%data(:, current_y_index, current_x_index)
   end if
  ...
  subroutine advect_flow_fields(current_state, current_x_index, current_y_index)
    ...
    current_state%u_advection = current_state%su%data(:, current_y_index, current_x_index)
    current_state%v_advection = current_state%sv%data(:, current_y_index, current_x_index)
    current_state%w_advection = current_state%sw%data(:, current_y_index, current_x_index)
