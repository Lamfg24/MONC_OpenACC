    ...
    if (.not. associated(ncdf_writer_state)) then
      ...
      if (.not. associated(ncdf_writer_state)) then
        ...
        call c_put_generic(file_states, trim(file_writer_information%filename)//"#"//trim(conv_to_string(timestep)), &
             generic, .false.)
        print*,"filename = ", trim(file_writer_information%filename)//"#"//trim(conv_to_string(timestep))
        ...
        print*,"file_writer_information%filename = ",file_writer_information%filename
