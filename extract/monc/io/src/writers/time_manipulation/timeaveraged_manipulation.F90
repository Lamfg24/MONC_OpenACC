...
contains  
  ...
  type(data_values_type) function perform_timeaveraged_time_manipulation(instant_values, output_frequency, &
    ...
    print*,"perform_timeaveraged_time_manipulation0000"
    ...
    print*,"perform_timeaveraged_time_manipulation0000bis"
    print*,"perform_timeaveraged_time_manipulation nint(time) = ",nint(time)
    print*,"perform_timeaveraged_time_manipulation nint(output_frequency) = ",nint(output_frequency)
    print*,"perform_timeaveraged_time_manipulation timestep = ",timestep
    ...
    if (select_value) then
      print*,"perform_timeaveraged_time_manipulation11111"
