...
contains
  ...
  type(component_descriptor_type_v1) function iterativesolver_single_prec_get_descriptor()
    ...
    iterativesolver_single_prec_get_descriptor%published_fields_on_off = .false.
