...
!(but transfer number to the mode selected by iact_mode below)  
  ...
  logical, target :: l_phomc_wisener   = .true.  ! homogeneous freezing of cloud droplets Wisener scheme 1972
  logical, target :: l_phomc_seifert   = .true.  ! homogeneous freezing of cloud droplets Seifert scheme 2006
  ...
  type :: process_switch
     ...
     logical, pointer :: l_phomc_wisener ! homogeneous freezing of cloud droplets Wisener scheme 1972
     logical, pointer :: l_phomc_seifert ! homogeneous freezing of cloud droplets Seifert scheme 2006
  ...
  !   soluble_modes(:) = (/ 0, 2, 2/)
  !   insoluble_modes(:) = (/ 0, 2/)
  logical :: opt_aerosol_param_user = .false.
...
contains
  ...
  subroutine derive_logicals()
    ...
    pswitch%l_phomc_wisener=>l_phomc_wisener ! homogeneous freezing of cloud droplets Wisener scheme 1972
    pswitch%l_phomc_seifert=>l_phomc_seifert ! homogeneous freezing of cloud droplets Seifert scheme 1972
    ...
    if (.not. (pswitch%l_praut .or. pswitch%l_pracw .or. pswitch%l_piacw .or. &
         pswitch%l_psacw .or. pswitch%l_pgacw .or. (pswitch%l_phomc_wisener .or. pswitch%l_phomc_seifert))) l_pos1=.false.
